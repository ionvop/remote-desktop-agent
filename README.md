...
* 🖥 **Agent** (Python) — Runs on the target machine
* 🌐 **Dashboard** (HTML/JS) — Web UI for remote interaction
...
Coordinates are **normalized (0–1)** and scaled to screen resolution.
